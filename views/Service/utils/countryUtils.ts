...
export function getCountry(countryCode?: boolean) {
  const countries: any = {
    AD: 'Andorra',
  ...
  const countryReturn = countries[country];
...
export const getContinent = (): null | string => {
  return continent[getCountry(true)];
};
